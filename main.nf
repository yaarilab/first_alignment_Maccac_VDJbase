...
input:
 set val(db_name), file(germlineFile) from g_4_germlineFastaFile_g92_17
...
input:
 set val(db_name), file(germlineFile) from g_2_germlineFastaFile_g92_22
...
input:
 ...
 set val(name1), file(v_germline_file) from g_2_germlineFastaFile_g92_12
 set val(name2), file(d_germline_file) from g_3_germlineFastaFile_g92_12
 set val(name3), file(j_germline_file) from g_4_germlineFastaFile_g92_12
...
input:
 ...
 set val(name2), file(v_ref) from g_2_germlineFastaFile_g92_43
...
input:
 ...
 set val(name4), file(v_ref) from g_2_germlineFastaFile_g92_47
